...
class TestReprocessVisitImageOutputs(lsst.utils.tests.TestCase):
    ...
    def setUp(self):
        ...
        self.dataId = {"detector": 148, "visit": 2025050200387, "band": "r"}
        self.exposure = self.butler.get("visit_image", self.dataId)
        self.catalog = self.butler.get("source_footprints", self.dataId)
